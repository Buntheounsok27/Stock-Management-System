...
public class ReferenceMethod {
	...
	public static void storeUserReportToDatabase()
	{
		...
		{
			con = (com.mysql.jdbc.Connection) DriverManager.getConnection(DataMysqlConnection.getUrl(),DataMysqlConnection.getUser(),DataMysqlConnection.getPassword());
			String sqlacc = "INSERT INTO tblreportuser values(null,'"+UserPerforment.getUserIDS()+"','"+UserPerforment.getLoginDateS()+
					"','"+UserPerforment.getLoginTimeS()+"','"+UserPerforment.getLogoutTimeS()+"','"+UserPerforment.getLogoutDateS()+"')";
