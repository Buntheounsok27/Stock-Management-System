...
public class Customer_Selected extends JFrame {
	...
	private void btnYes_Clicked(ActionEvent eve,JFrame frame)
	{
		...
		Cash_Register_Page.lblShDiscount.setText(Customer_Accessable.getDiscountS());
		frame.setEnabled(true);
		this.dispose();
	}
	...
	private void rowSel_Clicked(MouseEvent eve)
	{
		...
		if(sel>-1)
		{
			...
			try
			{
				...
				String sqlacc = "Select Discount from tblmember where MemberType = '"+defaultTableModel.getValueAt(sel, 2)+"'";
